...
// ─── COMPETITION ──────────────────────────────────────────────────────────────
const COMPETITION_ID = '4a905558-8a94-4dc2-8305-bce37bfc1fe4'
...
export default function TunaInternationalScoreboard() {
    ...
    <div style={S.page}>
      ...
      <div style={{ background: NAVY, color: 'white', padding: '1rem 1.5rem', borderRadius: 8, marginBottom: '1.25rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '0.5rem' }}>
          <div>
            <div style={{ fontWeight: 700, fontSize: '1.1rem' }}>🌍 SADSAA Tuna International 2026</div>
            <div style={{ fontSize: '0.82rem', opacity: 0.85, marginTop: 2 }}>
              Atlantic Boat Club, Hout Bay · International · {fishingHours.toFixed(0)} hrs total fishing
            </div>
          </div>
      ...
      {!loading && activeTab === 'team' && (
        <div style={S.card}>
          ...
          <div style={{ fontSize: '0.78rem', color: GREY, marginBottom: '1rem' }}>
            Ranked by cumulative points. Scoring: weight² × line class factor · International format
          </div>
